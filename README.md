...
| <img src="mods/Wild@Gen1BattleUI/thumbnail.png" width="54" alt=""> | **[Gen1BattleUI](https://github.com/wild1walker/Gen1BattleUI)** | The battle command and move menus as four buttons in a 2x2 grid instead of a list, drawn in the game's own text boxes. Dialogue still takes the bottom of the screen back for as long as it is talking. Both battle layouts. |
