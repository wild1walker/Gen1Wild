...
touches ends up somewhere you can go back to tomorrow.

## Nothing vanilla is taken away
...
nobody ever answered is a home invented, and levels always come from the map
you find it on, so a Charmander you meet on Victory Road is one you can
actually use.

**Trade evolutions** get a **LINK CABLE**, on the shelf in Celadon Department
Store beside the evolution stones and priced like one. It buys exactly one
evolution and snaps on the way out.
...
*losable*. On the cartridge, knocking one out by accident deletes that species
from your file forever. Beat one or flee it here and it is standing there
again when you come back; catch it and it is gone, exactly as it always was.
...
## Every decision has its own switch

The exclusives, the gift mons, the fossils, the renewable Snorlax, the LINK
CABLE, the Mew event, the legendary rule and the overall rarity are all
separate options. Want the version exclusives but not a wild Mew? Turn one off.
That was the whole reason this mod exists rather than the one before it.

## Credit

Downstream of [All Pokémon Catchable
